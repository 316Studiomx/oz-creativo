...
export const COPY = {
    ...
    companies: [
      {
        ...
        alt: 'Equipo de 316Studio frente al muro amarillo de la agencia.',
      ...
      },
      {
        ...
        alt: 'Auditorio lleno durante una conferencia de Cúspide Mx.',
      ...
      },
      {
        ...
        alt: 'Producción de evento con integrante usando camiseta de Plexx.',
        href: '#hablemos',
      },
      {
        name: 'Propulsor',
        description: 'Iniciativa para impulsar ideas, negocios y personas con estrategia accionable.',
        src: '/assets/companies/propulsor.jpg',
        alt: 'Escenario de Propulsor con público y pantallas de marca.',
        href: '#hablemos',
      },
    ],
  },
  ...
  track: {
    ...
    proofItems: [
      {
        label: 'Entrepreneur México',
        caption: 'Presencia en espacios editoriales y empresariales donde se habla de emprendimiento real.',
        src: '/assets/scenarios/entrepreneur-mexico.jpg',
        alt: 'Oz Creativo dando conferencia en un auditorio con pantalla de Entrepreneur en Español.',
        href: '#hablemos',
      },
      {
        label: 'Lead Summit (Maxwell Leadership)',
        caption: 'Participación y reconocimiento dentro de un escenario de liderazgo internacional.',
        src: '/assets/scenarios/lead-summit-stage.jpg',
        alt: 'Oz Creativo dando una charla en escenario de Lead Summit de Maxwell Leadership.',
        href: '#hablemos',
      },
      {
        label: 'Gigantes del futuro',
        caption: 'Conversaciones y escenarios creados para empresarios, equipos y nuevas generaciones.',
        src: '/assets/scenarios/gigantes-del-futuro.jpg',
        alt: 'Oz Creativo hablando frente a audiencia en el festival Gigantes del Futuro.',
        href: '#hablemos',
      },
      {
      ...
      {
        label: '+150 Conferencias',
        caption: 'Mensajes sobre marketing, ventas, emprendimiento, creatividad e innovación.',
        src: '/assets/scenarios/150-conferencias.jpg',
        alt: 'Oz Creativo dando conferencia frente a un auditorio lleno.',
        href: '#hablemos',
      },
      {
        label: '+50 Workshops corporativos',
        caption: 'Sesiones de trabajo para equipos que necesitan vender, comunicar y ejecutar mejor.',
        src: '/assets/scenarios/50-workshops-corporativos.jpg',
        alt: 'Oz Creativo impartiendo un taller corporativo frente a una pantalla.',
        href: '#hablemos',
      },
      {
        label: '+40 ciudades en 6 países',
        caption: 'Experiencia llevando ideas, formación y estrategia a distintos mercados.',
        src: '/assets/scenarios/40-ciudades-6-paises.jpg',
        alt: 'Vista desde un avión sobre una ciudad al atardecer como referencia de viajes.',
        href: '#hablemos',
      },
      {
        label: '+80,000 personas',
        caption: 'Audiencias alcanzadas entre conferencias, eventos, workshops y comunidad.',
        src: '/assets/scenarios/80000-personas.jpg',
        alt: 'Oz Creativo en escenario frente a una audiencia durante una conferencia.',
        href: '#hablemos',
      },
    ],
    accreditations: [
      ...
      },
      {
        ...
        src: '/assets/accreditations/startup-mexico.jpg',
        alt: 'Oz Creativo usando playera de StartUp México en oficina.',
        href: '#hablemos',
      },
      {
        label: 'Meta Marketing Digital',
        caption: 'Certificado por Meta en fundamentos y estrategia de marketing digital.',
        src: '/assets/accreditations/meta-marketing-digital.jpg',
        alt: 'Oz Creativo sosteniendo insignia de certificación de Meta Marketing Digital.',
        href: '#hablemos',
      },
      {
        label: 'Hora Cero',
        caption: 'Columnista con ideas sobre negocio, marca, liderazgo y emprendimiento.',
        src: '/assets/accreditations/hora-cero.jpg',
        alt: 'Laptop mostrando publicaciones de Oz Creativo en Hora Cero.',
        href: '#hablemos',
      },
      {
        label: 'Forbes 2026',
      ...
      },
      {
        ...
        src: '/assets/accreditations/lead-summit.jpg',
        alt: 'Oz Creativo recibiendo reconocimiento en Lead Summit de John Maxwell.',
        href: '#hablemos',
      },
      {
        label: 'Mejor Q’ Ayer',
        caption: 'Embajador de una comunidad enfocada en mejora personal y crecimiento.',
        src: '/assets/accreditations/mejor-que-ayer.jpg',
        alt: 'Oz Creativo en producción de video para Mejor Q Ayer.',
        href: '#hablemos',
      },
      {
        label: '+$1M USD en anuncios',
        caption: 'Más de un millón de dólares invertidos en pauta digital y aprendizaje real.',
        src: '/assets/accreditations/inversion-anuncios.jpg',
        alt: 'Oz Creativo frente a dashboards de anuncios y resultados de marketing.',
        href: '#hablemos',
      },
    ],
  },
